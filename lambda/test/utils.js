...
async function waitForValueChange(page, selectors, iterationCount, timeout, efficiency, logger) {
    return (await page.evaluate((selectors, targetValue, timeout) => {
        return (new Promise((resolve, reject) => {
            ...
            console.log(`Parts placed: ${info_placed}`);
            logger.info(`Parts placed: ${info_placed}`);
            ...
            const observer = new MutationObserver(() => {
                ...
                if (efficiency >= info_efficiency.textContent) {
                    ...
                    logger.info('Efficiency threshold reached!');
                    logger.info(`Efficiency limit: ${efficiency}`);
                    logger.info(`Efficiency reached: ${info_efficiency.textContent}`);
                    observer.disconnect();
                    resolve();
                }
            });
...
module.exports = { waitForValueChange, printStatistics, initialSetup }
