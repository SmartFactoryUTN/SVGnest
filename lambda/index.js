...
export const handler = async (event, context, callback) => {
    ...
    function printStatistics(initialCpuUsage, initialMemoryUsage, startTime) {
    ...
    try {
        ...
        await page.goto(event.url || 'https://master--svg-nest.netlify.app/', {timeout: 0});
        ...
        await browser.close();
        printStatistics(initialCpuUsage, initialMemoryUsage, startTime);
